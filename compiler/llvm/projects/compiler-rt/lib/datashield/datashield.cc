...
//#endif
//  void* ptr = __mspace_malloc(unsafe_region, n);
//  memset(ptr, 0, n);
...
//#endif
//  void* ptr = __mspace_malloc(safe_region, n);
...
//  DEBUG("unsafe free: %p\n", ptr);
//  DEBUG_ASSERT((size_t)ptr < BOUNDARY);
//  __mspace_free(unsafe_region, ptr);
//}
//// frees
//extern "C" __attribute__((visibility("default")))
...
//  ++__ds_num_unsafe_heap_allocs;
//#endif
//  void* ptr = __mspace_calloc(unsafe_region, n, elem_size);
...
//  ++__ds_num_safe_heap_allocs;
//#endif
//  void* ptr = __mspace_calloc(safe_region, n, elem_size);
...
//  void* new_ptr = __mspace_realloc(unsafe_region, ptr, n);
...
//  void* new_ptr = __mspace_realloc(safe_region, ptr, n);
...
//
//extern "C" __attribute__((visibility("default")))
//void __ds_copy_environ_to_unsafe(char** origenviron) {
//  DEBUG("(copy environ): %p\n", origenviron);
//  if (!origenviron) { return; }
//  int n = 0;
//  while(origenviron[n++]) {
//    // do nothing
//  }
//  n--;
//  __ds_environ = (char**)__ds_unsafe_malloc(sizeof(char*)*n + 1);
//  __ds_environ[n] = 0;
//  for (int i = 0; i < n; ++i) {
//    DEBUG("copying: %s\n", origenviron[i]);
...
//    __ds_environ[i] = (char*)__ds_unsafe_malloc(n);
//    //__dc_set_fn_arg_bounds_debug(1, __dc_infinite_bounds, (char*) where);
//    //__dc_set_fn_arg_bounds_debug(2, __dc_infinite_bounds, (char*) where);
//    strcpy(__ds_environ[i], origenviron[i]);
//  }
//  for (int i = 0; i < n; ++i) {
//    DEBUG("%s\n", __ds_environ[i]);
//  }
...
//
//extern "C" __attribute__((visibility("default")))
//__ds_bounds_t __ds_get_fn_arg_bounds_debug(size_t i, char* msg) {
//  __ds_bounds_t bounds = __ds_fn_args_array[i];
//  DEBUG("(get fn args) @ %li => [%p, %p). from: %s\n", i, bounds.base, bounds.last, msg);
//#ifdef DEBUG_MODE
...
////  }
////
////  unsafe_region = __create_mspace_with_base(unsafe_heap, UNSAFE_HEAP_SIZE, 0);
////
...
////    assert(0);
////  }
////  safe_region = __create_mspace_with_base(safe_heap, SAFE_HEAP_SIZE, 0);
////
...
//extern "C" __attribute__((visibility("default")))
//void __ds_set_fn_arg_bounds(size_t i, __ds_bounds_t bounds, char* msg) {
//  __ds_fn_args_array[i] = bounds;
//}
//
//extern "C" __attribute__((visibility("default")))
//__ds_bounds_t __ds_get_fn_arg_bounds(size_t i, char* msg) {
...
//
//extern "C" __attribute__((visibility("default")))
//__ds_bounds_t __ds_get_bounds(void* ptrAddr, char* msg) {
//  size_t hash = __ds_hash(ptrAddr);
//  __ds_bounds_t bounds = __ds_table[hash].bounds;
//  return bounds;
//}
...
//  struct addrinfo* cur_new, *prev_new = nullptr, *new_head;
//  while (cur_old) {
...
//    ((TempBuffer*)buf)->buf = __ds_unsafe_malloc(buff_size);
//}
//
